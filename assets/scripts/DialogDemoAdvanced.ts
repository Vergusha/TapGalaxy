...
import { DialogChoiceUtils, DialogDataWithChoices } from './DialogChoiceSystem';
...
@ccclass('DialogDemoAdvanced')
export class DialogDemoAdvanced extends Component {
    // Original buttons
    @property({ type: Node })
    ...
    @property({ type: Node })
    complexScenarioButton: Node = null;
